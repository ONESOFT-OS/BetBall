...
const CreateUser = () => {
    ...
    return (
        <div
            className="w-full h-full bg-gradient-to-bl from-green-900 via-gray-900 to-black flex flex-col items-start ">
                    ...
                    <div className="flex flex-row space-x-36">
                        <div>
                            <label htmlFor="userType" className="flex flex-col gap-3 w-full max-w-sm">
                                ...
                                <Select defaultOptions={defaultUserRoles} required={true}
