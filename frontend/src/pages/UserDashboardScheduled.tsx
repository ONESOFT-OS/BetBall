...
import { UserHistoricItemScheduled} from "../components/UserHistoricItemScheduled";
...
export function UserDashboardScheduled (){
    return(
        <div className="main bg-[url('../assets/Gradient.svg')] bg-no-repeat bg-contain bg-dark-900 min-w-screen h-[100vw]">
            ...
            <div className="home pt-[100px] ">
                ...
                <div className="flex flex-col gap-4 pt-8 px-20">
                    ...
                    <Link to={'/user/dashboard/scheduled'}>  
                        <Text className="font-bold text-xl  text-green-500" >Agendados</Text>
                    </Link>
                    </div>
                    <UserHistoricItemScheduled action="APOSTAR"></UserHistoricItemScheduled>
                    <UserHistoricItemScheduled action="APOSTAR"></UserHistoricItemScheduled>
                    <UserHistoricItemScheduled action="APOSTAR"></UserHistoricItemScheduled>
                    <UserHistoricItemScheduled action="APOSTAR"></UserHistoricItemScheduled>
                    <UserHistoricItemScheduled action="APOSTAR"></UserHistoricItemScheduled>
